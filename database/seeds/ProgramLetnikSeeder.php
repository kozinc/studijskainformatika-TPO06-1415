...
class ProgramLetnikSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        ProgramLetnik::create(['id_programa'=>3, 'letnik'=>1, 'KT'=>60,'stevilo_obveznih_predmetov'=>4, 'stevilo_strokovnih_predmetov'=>4,'stevilo_prostih_predmetov'=>2, 'stevilo_modulov'=>0]);
