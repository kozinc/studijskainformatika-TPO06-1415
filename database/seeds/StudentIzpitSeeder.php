...
class StudentIzpitSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('student_izpit')->insert(['id_studenta'=>4, 'id_izpitnega_roka'=>71, 'tocke_izpita'=>68]);
        ...
        DB::table('student_izpit')->insert(['id_studenta'=>3, 'id_izpitnega_roka'=>118, 'ocena'=>4, 'tocke_izpita'=>38]);
        ...
        DB::table('student_izpit')->insert(['id_studenta'=>1, 'id_izpitnega_roka'=>106, 'ocena'=>4, 'tocke_izpita'=>34]);
        ...
        //2.letnik 1.semester
        DB::table('student_izpit')->insert(['id_studenta'=>1, 'id_izpitnega_roka'=>154, 'ocena'=>9, 'tocke_izpita'=>80]);
        DB::table('student_izpit')->insert(['id_studenta'=>1, 'id_izpitnega_roka'=>157, 'ocena'=>9, 'tocke_izpita'=>80]);
        DB::table('student_izpit')->insert(['id_studenta'=>1, 'id_izpitnega_roka'=>160, 'ocena'=>9, 'tocke_izpita'=>80]);
        DB::table('student_izpit')->insert(['id_studenta'=>1, 'id_izpitnega_roka'=>163, 'ocena'=>9, 'tocke_izpita'=>80]);
        ...
        DB::table('student_izpit')->insert(['id_studenta'=>16, 'id_izpitnega_roka'=>169, 'ocena'=>8, 'tocke_izpita'=>25]);
        DB::table('student_izpit')->insert(['id_studenta'=>16, 'id_izpitnega_roka'=>172, 'ocena'=>7, 'tocke_izpita'=>15]);
        DB::table('student_izpit')->insert(['id_studenta'=>16, 'id_izpitnega_roka'=>175, 'ocena'=>6, 'tocke_izpita'=>38]);
        DB::table('student_izpit')->insert(['id_studenta'=>16, 'id_izpitnega_roka'=>178, 'ocena'=>6, 'tocke_izpita'=>20]);
        DB::table('student_izpit')->insert(['id_studenta'=>16, 'id_izpitnega_roka'=>187, 'ocena'=>9, 'tocke_izpita'=>20]);
        DB::table('student_izpit')->insert(['id_studenta'=>16, 'id_izpitnega_roka'=>191, 'ocena'=>10, 'tocke_izpita'=>20]);

        //Rok Pogorelc
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>82, 'ocena'=>8, 'tocke_izpita'=>74]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>85, 'ocena'=>8, 'tocke_izpita'=>12]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>88, 'ocena'=>9, 'tocke_izpita'=>10]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>91, 'ocena'=>10, 'tocke_izpita'=>58]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>94, 'ocena'=>7, 'tocke_izpita'=>29]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>97, 'ocena'=>9, 'tocke_izpita'=>25]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>100, 'ocena'=>9, 'tocke_izpita'=>24]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>103, 'ocena'=>9, 'tocke_izpita'=>38]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>106, 'ocena'=>10, 'tocke_izpita'=>20]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>109, 'ocena'=>8, 'tocke_izpita'=>20]);
        //2.letnik
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>154, 'ocena'=>8, 'tocke_izpita'=>74]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>157, 'ocena'=>10, 'tocke_izpita'=>12]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>160, 'ocena'=>7, 'tocke_izpita'=>10]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>163, 'ocena'=>8, 'tocke_izpita'=>58]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>166, 'ocena'=>7, 'tocke_izpita'=>29]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>169, 'ocena'=>9, 'tocke_izpita'=>25]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>172, 'ocena'=>10, 'tocke_izpita'=>15]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>175, 'ocena'=>8, 'tocke_izpita'=>38]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>178, 'ocena'=>9, 'tocke_izpita'=>20]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>187, 'ocena'=>9, 'tocke_izpita'=>20]);
        DB::table('student_izpit')->insert(['id_studenta'=>17, 'id_izpitnega_roka'=>191, 'ocena'=>10, 'tocke_izpita'=>20]);


        //studenti od veronike
        DB::table('student_izpit')->insert(['id_studenta'=>19, 'id_izpitnega_roka'=>113, 'ocena'=>0, 'tocke_izpita'=>0]);
        DB::table('student_izpit')->insert(['id_studenta'=>20, 'id_izpitnega_roka'=>113, 'ocena'=>0, 'tocke_izpita'=>0]);
        DB::table('student_izpit')->insert(['id_studenta'=>21, 'id_izpitnega_roka'=>113, 'ocena'=>0, 'tocke_izpita'=>0]);
        DB::table('student_izpit')->insert(['id_studenta'=>22, 'id_izpitnega_roka'=>113, 'ocena'=>0, 'tocke_izpita'=>0]);
        DB::table('student_izpit')->insert(['id_studenta'=>23, 'id_izpitnega_roka'=>113, 'ocena'=>0, 'tocke_izpita'=>0]);
        DB::table('student_izpit')->insert(['id_studenta'=>24, 'id_izpitnega_roka'=>113, 'ocena'=>0, 'tocke_izpita'=>0]);
        DB::table('student_izpit')->insert(['id_studenta'=>25, 'id_izpitnega_roka'=>113, 'ocena'=>0, 'tocke_izpita'=>0]);
        DB::table('student_izpit')->insert(['id_studenta'=>26, 'id_izpitnega_roka'=>113, 'ocena'=>0, 'tocke_izpita'=>0]);
        DB::table('student_izpit')->insert(['id_studenta'=>27, 'id_izpitnega_roka'=>113, 'ocena'=>0, 'tocke_izpita'=>0]);
        DB::table('student_izpit')->insert(['id_studenta'=>28, 'id_izpitnega_roka'=>113, 'ocena'=>0, 'tocke_izpita'=>0]);
