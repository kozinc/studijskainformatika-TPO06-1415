...
class StudentProgramSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('student_program')->insert(['id_studenta'=>9, 'id_programa'=>1,'vrsta_vpisa'=>1, 'nacin_studija'=>'redni', 'prosta_izbira'=>1, 'vloga_oddana'=>'2012-09-20', 'vloga_potrjena'=>'2013-09-24', 'datum_vpisa'=>'2013-09-24', 'studijsko_leto'=>'2013/2014', 'letnik'=>2 ]);
        DB::table('student_program')->insert(['id_studenta'=>9, 'id_programa'=>1,'vrsta_vpisa'=>1, 'nacin_studija'=>'redni', 'prosta_izbira'=>1, 'vloga_oddana'=>'2012-09-20', 'vloga_potrjena'=>'2014-09-24', 'datum_vpisa'=>'2014-09-24', 'studijsko_leto'=>'2014/2015', 'letnik'=>3 ]);
